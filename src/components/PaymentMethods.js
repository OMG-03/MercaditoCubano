        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-gray-700">
              ...
              <li>Ingresa nuestro código e informa al agricultor el código de confirmación</li>
            </ol>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800">Transfermóvil</h3>
            </div>
            <ol className="list-decimal pl-5 space-y-2 text-gray-700">
              ...
              <li>Ingresa el monto y nuestro teléfono, e informa al agricultor el código de confirmación</li>
            </ol>
          </div>
        </div>
      </div>
