...
const ProductList = () => {
  ...
  const handleReserve = (product) => {
    ...
    localStorage.setItem('reservedProducts', JSON.stringify([...reservedProducts, product]));
  };

  return (
    <section className="py-16 bg-gradient-to-br from-green-50 via-blue-50 to-green-100" id="productos">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-extrabold text-green-900 mb-8 text-center tracking-tight drop-shadow">
          Productos disponibles <span className="text-green-600">(Día {currentDay})</span>
        </h2>
